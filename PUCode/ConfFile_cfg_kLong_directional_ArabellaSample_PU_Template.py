...
process.source = cms.Source("PoolSource",
    ...
    'root://cmsxrootd.fnal.gov//store/user/sapta/TimingStudies_9X/kLongTime_step3_PU/step3_kLong_Pt10_n40_partNPART1_directional_PU.root',
    'root://cmsxrootd.fnal.gov//store/user/sapta/TimingStudies_9X/kLongTime_step3_PU/step3_kLong_Pt10_n40_partNPART2_directional_PU.root',
   )
)

process.TFileService = cms.Service("TFileService", fileName = cms.string('HGCTiming_kLong_Pt10_SoverN5000ps_Floor30ps_PU_PartNPART.root'))
