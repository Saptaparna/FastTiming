...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring("root://cmsxrootd.fnal.gov//store/user/sapta/PUSamples_94X/kLongTime_step1_PU_24psSampling/step1_kLong_PtPT_nNEVENT_partNPART_directional_PU.root"),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step3 nevts:40'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_kLong_PtPT_nNEVENT_partNPART_directional_PU.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_inMINIAODSIM_kLong_PtPT_nNEVENT_partNPART_directional_PU.root'),
