// -*- C++ -*-
//
// Package:    HGCTimingAnalyzerWithTOAPU/HGCTimingAnalyzerWithTOAPU
// Class:      HGCTimingAnalyzerWithTOAPU
// 
/**\class HGCTimingAnalyzerWithTOAPU HGCTimingAnalyzerWithTOAPU.cc HGCTimingAnalyzerWithTOAPU/HGCTimingAnalyzerWithTOAPU/plugins/HGCTimingAnalyzerWithTOAPU.cc
...
#include "HGCTimingAnalyzer/HGCTimingAnalyzer/interface/UtilClasses.h"//synchronizing with Arabella
...
class HGCTimingAnalyzerWithTOAPU : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit HGCTimingAnalyzerWithTOAPU(const edm::ParameterSet&);
      ~HGCTimingAnalyzerWithTOAPU();
...
//      } simHitInfo;
   ...
   private:
      ...
      std::vector<int> recHit_isSignal;
      std::vector<int> recHit_isPU;
      std::vector<int> recHit_isSignalAndPU;
      //std::vector<simHitInfo> simHits;
      //simHitInfo simHit;
      std::map<uint32_t, simHitInfo> mapSimHits;
      //std::unordered_map<uint32_t, simHitInfo> mapSimHits;
