...
int makeComparison()
{
  ...
  TFile* file_new = TFile::Open("output_hgcalNtuple_April25_20k_May5_NoTimeCut.root");
  TH1F *hEnergyTotalRadiusTwo = (TH1F*)file_new->Get("h_EnergyTotalRadiusTwo");
  hEnergyTotalRadiusTwo->Rebin(2);
  hEnergyTotalRadiusTwo->GetXaxis()->SetRangeUser(20.0, 80.0);
  ...
  hEnergyTotalRadiusTwo->GetXaxis()->SetTitle("Total energy in a cynlinder without timing requirement [GeV]");
  ...
  c1.SaveAs("h_ShowerAxis_Energy.png");
  c1.SaveAs("h_ShowerAxis_Energy.pdf");
  return 0;
