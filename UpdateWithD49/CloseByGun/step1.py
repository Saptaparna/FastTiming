...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step1 nevts:1000000'),
...
process.generator = cms.EDProducer("CloseByParticleGunProducer",
    PGunParameters = cms.PSet(PartID = cms.vint32(22, 22, -11, 11, -13, 13, -211, 211, 311, 311), # Since I'm shooting antiparticles, I'm putting gamma and K0 twice in the vector
        EnMin = cms.double(25.),
        EnMax = cms.double(450.),
        RMin = cms.double(60),
        RMax = cms.double(120),
        ZMin = cms.double(320),
        ZMax = cms.double(321),
