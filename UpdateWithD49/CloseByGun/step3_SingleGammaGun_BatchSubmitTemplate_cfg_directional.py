...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cmseos.fnal.gov//store/user/lpchgcal/sapta/TimingSamples/MachineLearning/step2_Gamma_PtPT_nNEVENT_partNPART_directional.root'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_Gamma_PtPT_nNEVENT_partNPART_directional.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_Gamma_PtPT_nNEVENT_partNPART_directional_MINIAODSIM.root'),
