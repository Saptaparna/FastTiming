...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step1_Gamma_PtPT_nNEVENT_partNPART.root'),
...
process.generator = cms.EDProducer("CloseByParticleGunProducer",
    PGunParameters = cms.PSet(PartID = cms.vint32(-211, 211), # Since I'm shooting antiparticles, I'm putting gamma and K0 twice in the vector
        EnMin = cms.double(50.0),
        EnMax = cms.double(50.0),
        RMin = cms.double(60),
        RMax = cms.double(120),
        ZMin = cms.double(315),
        ZMax = cms.double(321),
