...
scramv1 b
cd -
cmsRun  step2_SingleGammaGun_BatchSubmit_NEVENT${1}_NPART${2}_En${3}_cfg_directional.py >& step2_SingleGammaGun_BatchSubmit_NEVENT${1}_NPART${2}_En${3}_directional.txt
EOF
...
transfer_input_files = Job_${1}_${2}_${3}_directional.csh, step2_SingleGammaGun_BatchSubmit_NEVENT${1}_NPART${2}_En${3}_cfg_directional.py, CMSSW_11_1_0_pre7.tar.gz
notification = Never
