...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('SinglePhotonPtENERGY_cfi nevts:NEVENT'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SinglePhotonGunPtENERGY_nNEVENT_partNPART.root'),
...
process.generator = cms.EDProducer("FlatRandomPtGunProducer",
    PGunParameters = cms.PSet(
        MaxPt = cms.double(ENERGY),
        MinPt = cms.double(ENERGY),
    ...
    psethack = cms.string('single photon pt ENERGY'),
