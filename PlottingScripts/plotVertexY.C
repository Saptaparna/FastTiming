...
void plotVertexY()
{
  ...
  TH1F *h1 = (TH1F*)file1->Get("h_vertex_y");
  h1->Rebin(5);
  ...
  TH1F *h2 = (TH1F*)file2->Get("h_vertex_y");
  h2->Rebin(5);
  ...
  TH1F *h3 = (TH1F*)file3->Get("h_vertex_y");
  h3->Rebin(5);
  ...
  TH1F *h4 = (TH1F*)file4->Get("h_vertex_y");
  h4->Rebin(5);
  ...
  c1.SaveAs("Vertex_y_SinglePhoton.pdf");
  c1.SaveAs("Vertex_y_SinglePhoton.png");
}
