...
void plotrecHitE_Z()
{
  ...
  TH1F *h1 = (TH1F*)file1->Get("h_recHit_Z");
  h1->Rebin(20);
  ...
  TH1F *h2 = (TH1F*)file2->Get("h_recHit_Z");
  h2->Rebin(20);
  ...
  TH1F *h3 = (TH1F*)file3->Get("h_recHit_Z");
  h3->Rebin(20);
  ...
  TH1F *h4 = (TH1F*)file4->Get("h_recHit_Z");
  h4->Rebin(20);
  ...
  c1.SaveAs("h_recHit_Z_SinglePhoton.pdf");
  c1.SaveAs("h_recHit_Z_SinglePhoton.png");
}
