...
void plotVertexX()
{
  ...
  TCanvas c1("c1","X coordinate of Vertex", 10, 10, 600, 400);
  
  TFile* file1 = TFile::Open("output_HGCTiming_SinglePhoton_Pt35GeV.root");
  TH1F *h1 = (TH1F*)file1->Get("h_vertex_x");
  h1->Rebin(5);
  ...
  TH1F *h2 = (TH1F*)file2->Get("h_vertex_x");
  h2->Rebin(5);
  ...
  TH1F *h3 = (TH1F*)file3->Get("h_vertex_x");
  h3->Rebin(5);
  ...
  TH1F *h4 = (TH1F*)file4->Get("h_vertex_x");
  h4->Rebin(5);
  ...
  c1.SaveAs("Vertex_x_SinglePhoton.pdf");
  c1.SaveAs("Vertex_x_SinglePhoton.png");
}
