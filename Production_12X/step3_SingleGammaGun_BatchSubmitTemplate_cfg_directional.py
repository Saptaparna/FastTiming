...
# with command line options: step3 --conditions auto:phase2_realistic_T15 -n 10 --era Phase2C11 --eventcontent FEVTDEBUGHLT,MINIAODSIM,DQM --runUnscheduled -s RAW2DIGI,L1Reco,RECO,RECOSIM,PAT,VALIDATION:@phase2Validation+@miniAODValidation,DQM:@phase2+@miniAODDQM --datatier GEN-SIM-RECO,MINIAODSIM,DQMIO --geometry Extended2026D49 --filein file:step2.root --fileout file:step3.root
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Phase2C11_cff import Phase2C11

process = cms.Process('RECO',Phase2C11)
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/uscms_data/d1/sapta/work/HighGranularityCalorimeter/MLForRecoSampleGeneration/PositionRegression/CMSSW_12_0_0_pre3/src/GammaTime_Step2/step2_Gamma_EEnergy_n1000_part1.root'),
...
process.FEVTDEBUGHLToutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_Gamma_EnEnergy_nNEVENT_partNPART.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3_Gamma_EnEnergy_nNEVENT_partNPART_directional_MINIAODSIM.root'),
...
process.validation_step5 = cms.EndPath(process.bTagPlotsMCbcl)
process.validation_step6 = cms.EndPath((process.TauValNumeratorAndDenominatorQCD+process.TauValNumeratorAndDenominatorRealData+process.TauValNumeratorAndDenominatorRealElectronsData+process.TauValNumeratorAndDenominatorRealMuonsData+process.TauValNumeratorAndDenominatorZEE+process.TauValNumeratorAndDenominatorZMM+process.TauValNumeratorAndDenominatorZTT))
process.validation_step7 = cms.EndPath(process.globalValidationHCAL)
process.validation_step8 = cms.EndPath(process.globalValidationHGCal)
process.validation_step9 = cms.EndPath(process.globalValidationMTD)
process.validation_step10 = cms.EndPath(process.globalValidationOuterTracker)
...
process.validation_step13 = cms.EndPath(process.validationMiniAOD)
