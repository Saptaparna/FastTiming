...
process = cms.Process('HLT',eras.Phase2C4_timing)
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('root://cmseos.fnal.gov//store/user/lpchgcal/sapta/TimingSamples/postTDR10X/GammaTime_step1_12fC/step1_Gamma_PtPT_nNEVENT_partNPART_directional.root'),
